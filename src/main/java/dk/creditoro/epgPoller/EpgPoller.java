...
public class EpgPoller {
	...
	public String parse (String responebody){
		//JSONArray channels = new JSONArray(responebody);
		org.json.JSONObject channels = new org.json.JSONObject(responebody);
	...
	public void addtoServer(){
		...
		for (ChannelData channelData : channelList) {
			...
			var body = new JSONObject(Map.of("name", channelData.getName()));
